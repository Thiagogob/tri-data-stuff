...
REGRESSION_DATA_CSV = Path('data') / "athlete_results" / "athlete_105480_performance_trend.csv"
...
def plot_pie_chart_plotly(df_medias):
    ...
    fig.update_traces(
        ...
        hovertemplate=(
            ...
            "Distribuição: %{percent}<extra></extra>"
        ),
